                                                ...
                                                <tr key={student.id}>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <button
                                                            ...
                                                            className={`inline-flex items-center px-3 py-2 border rounded-md text-sm font-medium ${attendance[student.id]
                    ...
                    <div className="mb-6">
                        <div className="flex justify-center space-x-4">
                            <button
                                ...
                                className={`inline-flex items-center px-4 py-2 rounded-md text-sm font-medium ${viewMode === 'attendance'
                            ...
                            <button
                                ...
                                className={`inline-flex items-center px-4 py-2 rounded-md text-sm font-medium ${viewMode === 'students'
                                        ? 'bg-indigo-600 text-white'
                                        : 'bg-white text-gray-700 hover:bg-gray-50 border border-gray-300'
                                    }`}
                            >
